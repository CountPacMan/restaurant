  ...
  class Restaurant {
    ...
    */
    ...
    /* 1. Create null variable found_task; will be returned by function.
       2. Get all existing Restaurant objects; assign to new array called tasks.
    ...
    */
    ...
    /* 1. Get all rows from DB and assign to variable returned_tasks.
       ...
       3. Get values from each column of returned_tasks; assign to temp
          variables.
       4. Instantiate new Restaurant object passing temp variables from row.
       5. Push new Restaurant to tasks array.
